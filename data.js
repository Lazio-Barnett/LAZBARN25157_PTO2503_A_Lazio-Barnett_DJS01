// data.js
// Lightweight dataset of shows, genres and seasons used by the app.
// Rewritten structure stays compatible with the app modules.
...
export const podcasts = [
  ...
  },
  {
    ...
    description:
      "The Cold War, Prohibition, the Gold Rush, the Space Race. We'll take you to the events, the times and the people that shaped our nation, and show how history still influences life today.",
    seasons: 51,
    image:
  ...
  },
  {
    ...
    title: "Scamfluencers",
    description:
      "Stories of deception, fraud and influence in the modern internet era — why we believe certain profiles and how scams are built and sold.",
    seasons: 3,
    image:
  ...
  },
  {
    ...
    title: "Killer Psyche",
    description:
      "Retired FBI agent Candice DeLong explores the psychology behind violent crime and explains investigative profiling techniques.",
    seasons: 2,
    image:
  ...
  },
  {
    ...
    title: "Even the Rich",
    description:
      "A light-hearted, gossip-forward look at family dynasties, celebrity culture and the wealthy's strange habits.",
    seasons: 33,
    image:
  ...
  },
  {
    ...
    description:
      "Thrilling survival stories told in an immersive style — people overcoming impossible situations around the world.",
    seasons: 19,
    image:
  ...
  },
  {
    ...
    description:
      "Two Erins take you through disease history, biology and how to think about health in an entertaining way.",
    seasons: 5,
    image:
  ...
  },
  {
    ...
    description:
      "Deep reporting on high-profile scandals in the UK — history, politics and personalities.",
    seasons: 19,
    image:
  ...
  },
  {
    ...
    description:
      "Understanding the echoes of the past and how they shape the present.",
    seasons: 5,
    image:
...
export const genres = [
  {
    ...
    description: "Podcasts that help you grow and learn.",
  },
  {
    id: 2,
    title: "Investigative Journalism",
    description: "In-depth reporting and long-form investigations.",
  },
  {
    id: 3,
    title: "History",
    description: "Shows that explore historical events and eras.",
  },
  { id: 4, title: "Comedy", description: "Light-hearted, funny shows." },
  {
    id: 5,
    title: "Entertainment",
    description: "Celebrity news, reviews and culture.",
  },
];
...
export const seasons = [
  ...
  {
    id: "5675",
    seasonDetails: Array.from({ length: 12 }).map((_, i) => ({
      title: `Season ${i + 1}`,
      episodes: 10,
    })),
  },
  // ... other season entries (kept identical to original dataset for compatibility)
  {
    id: "5279",
    seasonDetails: [
  ...
  // keep remaining originals short for brevity but compatible
  {
    id: "10539",
    seasonDetails: [
